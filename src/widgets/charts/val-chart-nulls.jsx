...
export function ValChartNulls({showSegments}) {
  
  const data = [
    {
      label: "Total Nulls in Revenue",
      data: [],
    },
    {
      label: "Merchant 1",
  ...
  for (let i = 20; i < 37; i++) {
    ...
    if (showSegments){
      // Generate a random value between 80 and 85
      const value2 = Math.random() * (10) + 100;
