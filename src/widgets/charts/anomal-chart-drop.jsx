...
export function AnomalChartDrop({showSegments}) {
  
  const data = [
    {
      label: "Total 'Num Shops'",
      data: [],
    },
    {
      label: "Merchant 1",
  ...
  for (let i = 0; i < 30; i++) {
    ...
    if (showSegments){
      const valu2 = Math.random() * (30) + 100;
      ...
      for (let j=2; j<5; j++){
        const valu3 = Math.random() * (30) + 100;
    ...
    const value = Math.random() * (50) + 500;
